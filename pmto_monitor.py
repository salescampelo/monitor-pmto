...
# Termos para menções diretas ao Cel. Barbosa
TERMS_DIRECT = [
    "coronel barbosa",
    "márcio barbosa",
    "marcio barbosa",
...
# ─────────────────────────────────────────────
# FONTES DE MONITORAMENTO (20 fontes)
# ─────────────────────────────────────────────
...
class Source:
    ...
    name: str
    url: str
    source_type: str  # Blog, Portal, Jornal, Agência, Institucional, TV/Portal
    priority: str     # alta, media, complementar
    section: str = "" # Seção específica do site (ex: /policia, /estado)
...
SOURCES = [
    # ── PRIORIDADE ALTA ──
    Source("Luiz Armando Costa", "https://www.luizarmandocosta.com.br", "Blog", "alta"),
    Source("T1 Notícias", "https://t1noticias.com.br", "Portal", "alta", "/estado/"),
    Source("Cleber Toledo", "https://clebertoledo.com.br", "Blog", "alta", "/categoria/tocantins/"),
    Source("AF Notícias", "https://afnoticias.com.br", "Portal", "alta"),
    Source("Atitude Tocantins", "https://atitudeto.com.br", "Portal", "alta"),
    Source("Jornal do Tocantins", "https://www.jornaldotocantins.com.br", "Jornal", "alta"),
    Source("Gazeta do Cerrado", "https://gazetadocerrado.com.br", "Portal", "alta"),

    # ── PRIORIDADE MÉDIA ──
    Source("Conexão Tocantins", "https://conexaoto.com.br", "Portal", "media"),
    Source("Agência Tocantins", "https://www.agenciatocantins.com.br", "Agência", "media", "/policia"),
    Source("Sou de Palmas", "https://soudepalmas.com.br", "Portal", "media"),
    Source("Portal O Tocantins", "https://otocantins.com.br", "Portal", "media"),
    Source("Foco Tocantins", "https://focotocantins.com.br", "Portal", "media"),
    Source("Jornal Tocantins News", "https://jornaltocantinsnews.com.br", "Portal", "media"),
    Source("Notícia Tocantins", "https://noticiatocantins.com.br", "Portal", "media"),

    # ── COMPLEMENTARES ──
    Source("Tocantins Agora", "https://www.tocantinsagora.com.br", "Portal", "complementar"),
    Source("Portal O Norte", "https://www.portalonorte.com.br", "Portal", "complementar"),
    Source("Portal Norte (SBT)", "https://portalnorte.com.br", "TV/Portal", "complementar", "/regiao/tocantins/"),
    Source("Tocantins Notícia", "https://tonoticia.com.br", "Portal", "complementar"),
    Source("Portal Fatos e Notícias", "https://www.portalfatosenoticias.com.br", "Portal", "complementar"),
    Source("PMTO Oficial", "https://www.to.gov.br/pm/noticias", "Institucional", "complementar"),
]
...
class Article:
    ...
    mention_type: str = ""       # "direta", "institucional", "crise"
    detected_at: str = ""
    snippet: str = ""
    hash_id: str = ""
...
def build_email_subject(articles: list[Article]) -> str:
    ...
    if diretas:
        return f"🔴 [{len(diretas)} direta(s)] Alerta PMTO — {total} menção(ões)"
    return f"🟡 Alerta PMTO — {total} menção(ões) institucional(is)"
    ...
    for source in SOURCES:
        ...
        for raw in raw_articles:
            ...
            article = Article(
                ...
                matched_terms=check["matched_terms"] + check["crisis_terms"],

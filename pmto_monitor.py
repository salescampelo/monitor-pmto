...
=================================================================
Script de monitoramento automatizado de imprensa — Brasil inteiro.
Varre 32 fontes (18 TO + 14 BR), detecta menções e envia alertas via e-mail.
...
def run_scan():
    ...
    for source in SOURCES:
        ...
        for raw in raw_articles:
            ...
            # Filtra domínios bloqueados (PMTO oficial, Gov TO)
            url_lower = raw["url"].lower()
            if any(d in url_lower for d in ["to.gov.br", "doe.to.gov.br"]):
                continue
